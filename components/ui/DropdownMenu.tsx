...
function DropdownMenuItem({
  ...
  return (
    <MenuPrimitive.Item
      ...
      className={cn(
        "group/dropdown-menu-item relative flex cursor-pointer items-center gap-2 rounded-md px-2.5 py-2 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 data-inset:pl-7 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        'not-data-[variant=destructive]:hover:bg-teal-50 not-data-[variant=destructive]:hover:text-teal-700 not-data-[variant=destructive]:focus:bg-teal-50 not-data-[variant=destructive]:focus:text-teal-700 dark:not-data-[variant=destructive]:hover:bg-teal-950/40 dark:not-data-[variant=destructive]:hover:text-teal-300 dark:not-data-[variant=destructive]:focus:bg-teal-950/40 dark:not-data-[variant=destructive]:focus:text-teal-300',
