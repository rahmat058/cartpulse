...
export function StoreDrawer({ open, mode, storeId, onClose, onSuccess }: StoreDrawerProps) {
  ...
  const title = mode === 'create' ? 'Add store' : 'Edit store'
        ...
        <>
          ...
          >
              ...
              <div className="flex items-center justify-between gap-3">
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    {mode === 'create'
                      ? 'Create a new storefront with catalog and checkout settings.'
                      : 'Update store details, branding, and commerce defaults.'}
                  </p>
                </div>
                <button
                  type="button"
            ...
            <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
              <StoreForm
                key={mode === 'create' ? 'create-store' : storeId}
                storeId={mode === 'edit' ? storeId : undefined}
                variant="drawer"
                onClose={onClose}
                onSuccess={onSuccess}
              />
