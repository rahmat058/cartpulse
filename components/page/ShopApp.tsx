    ...
    <StorefrontContainer as="main" className="py-10">
      <motion.div
        ...
        <p className="mx-auto mt-3 max-w-xl text-sm text-slate-500 sm:text-base">
          Add items, update quantities, and watch subtotal, tax, shipping, and discounts recalculate via Redux
          selectors.
        </p>
      </motion.div>
      ...
      {catalogStatus === 'succeeded' && (
        <motion.div
          ...
          <section className="glass-card p-5 sm:p-6" aria-label="Product catalog">
