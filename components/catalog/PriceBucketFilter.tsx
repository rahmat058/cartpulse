...
export function PriceBucketFilter() {
  ...
  return (
    <div className="space-y-1">
      <label
        className={cn(
          'flex cursor-pointer items-center justify-between rounded-md px-2 py-2 transition-colors hover:bg-teal-50/60',
      ...
      <div className="mt-3 rounded-md bg-teal-50/50 px-3 py-2 text-xs text-slate-500">
